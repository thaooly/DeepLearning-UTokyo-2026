...
def pretrain_autoencoder(x_train, hyperparameters, device):
    ...
    optimizer = torch.optim.Adam(
        ae_model.parameters(),
        lr=hyperparameters.get("ae_learning_rate", 1e-3)
    )
...
def main():
    ...
    print(summary(model=model, input_data=torch.rand(input_size, device=device), depth=5))
    print("=" * 60)
    ...
    print(f"  Flags      : AE={hyperparameters['use_autoencoder']}  "
